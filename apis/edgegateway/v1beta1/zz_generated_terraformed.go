...
// GetTerraformResourceType returns Terraform resource type for this VPN
func (mg *VPN) GetTerraformResourceType() string {
	return "vcd_edgegateway_vpn"
}

// GetConnectionDetailsMapping for this VPN
func (tr *VPN) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"shared_secret": "spec.forProvider.sharedSecretSecretRef"}
}

// GetObservation of this VPN
func (tr *VPN) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this VPN
func (tr *VPN) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this VPN
func (tr *VPN) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this VPN
func (tr *VPN) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this VPN
func (tr *VPN) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this VPN using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VPN) LateInitialize(attrs []byte) (bool, error) {
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *VPN) GetTerraformSchemaVersion() int {
	return 0
}
