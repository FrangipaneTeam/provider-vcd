...
// GetTerraformResourceType returns Terraform resource type for this Bundle
func (mg *Bundle) GetTerraformResourceType() string {
	return "vcd_rights_bundle"
}

// GetConnectionDetailsMapping for this Bundle
func (tr *Bundle) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this Bundle
func (tr *Bundle) GetObservation() (map[string]any, error) {
...
// SetObservation for this Bundle
func (tr *Bundle) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this Bundle
func (tr *Bundle) GetID() string {
...
// GetParameters of this Bundle
func (tr *Bundle) GetParameters() (map[string]any, error) {
...
// SetParameters for this Bundle
func (tr *Bundle) SetParameters(params map[string]any) error {
...
// LateInitialize this Bundle using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Bundle) LateInitialize(attrs []byte) (bool, error) {
...
func (tr *Bundle) GetTerraformSchemaVersion() int {
	return 0
}
