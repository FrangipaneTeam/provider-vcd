...
type RoutedV2MetadataEntryObservation struct {
}

type RoutedV2MetadataEntryParameters struct {
...
type RoutedV2Parameters struct {
	...
	// +crossplane:generate:reference:type=github.com/FrangipaneTeam/provider-vcd/apis/nsxt/v1beta1.EdgeGateway
	// +kubebuilder:validation:Optional
	EdgeGatewayID *string `json:"edgeGatewayId,omitempty" tf:"edge_gateway_id,omitempty"`

	// Reference to a EdgeGateway in nsxt to populate edgeGatewayId.
	// +kubebuilder:validation:Optional
	EdgeGatewayIDRef *v1.Reference `json:"edgeGatewayIdRef,omitempty" tf:"-"`

	// Selector for a EdgeGateway in nsxt to populate edgeGatewayId.
	// +kubebuilder:validation:Optional
	...
	// +kubebuilder:validation:Optional
	MetadataEntry []RoutedV2MetadataEntryParameters `json:"metadataEntry,omitempty" tf:"metadata_entry,omitempty"`
	...
	// +kubebuilder:validation:Optional
	StaticIPPool []RoutedV2StaticIPPoolParameters `json:"staticIpPool,omitempty" tf:"static_ip_pool,omitempty"`
...
type RoutedV2StaticIPPoolObservation struct {
}

type RoutedV2StaticIPPoolParameters struct {
