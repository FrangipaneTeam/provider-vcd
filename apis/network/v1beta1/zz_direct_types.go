...
type DirectParameters struct {
	...
	// The name of the external network
	// +crossplane:generate:reference:type=ExternalNetworkV2
	// +kubebuilder:validation:Optional
	ExternalNetwork *string `json:"externalNetwork,omitempty" tf:"external_network,omitempty"`

	// Reference to a ExternalNetworkV2 to populate externalNetwork.
	// +kubebuilder:validation:Optional
	ExternalNetworkRef *v1.Reference `json:"externalNetworkRef,omitempty" tf:"-"`

	// Selector for a ExternalNetworkV2 to populate externalNetwork.
	// +kubebuilder:validation:Optional
	ExternalNetworkSelector *v1.Selector `json:"externalNetworkSelector,omitempty" tf:"-"`
