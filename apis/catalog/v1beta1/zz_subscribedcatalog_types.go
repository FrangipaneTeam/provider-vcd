...
type SubscribedCatalogObservation struct {
	...
	// Optional metadata of the catalog. This is inherited from the publishing catalog and updated on sync.
...
type SubscribedCatalogParameters struct {
	...
	SubscriptionURL *string `json:"subscriptionUrl" tf:"subscription_url,omitempty"`
