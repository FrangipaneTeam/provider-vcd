...
import (
	...
	v1beta1 "github.com/FrangipaneTeam/provider-vcd/apis/vdc/v1beta1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["vcd_vdc_group"],
