...
# In python get all .md files in this direcotry (.work/vmware/vcd/docs/resources) and extract title for each file
            ...
            with open('.work/vmware/vcd/website/docs/r/'+file) as f:
                for line in f:
                    if line.startswith('# vcd'):
                        ...
                        group = ''
                        with open('.work/vmware/vcd/website/docs/r/'+file) as x:
                            for l in x:
                            ...
                            for l in x:
                                ...
                                if l.find(line[2:-1]) != -1:
                                    ...
                                    linesImplementedPrint[group].append(
                                        '* [x] [' + line[2:-1] + '](https://registry.terraform.io/providers/vmware/vcd/latest/docs/resources/' + file[0:-14] + ')')
                                    break

                        if found == False:
                            countNotImplemented += 1
                            linesNotImplementedPrint[group].append(
                                '* [ ] [' + line[2:-1] + '](https://registry.terraform.io/providers/vmware/vcd/latest/docs/resources/' + file[0:-14] + ')')
                        break
